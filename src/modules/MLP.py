...
class MultiLayerPerceptron(nn.Module):
    ...
    def forward(self, history_data: torch.Tensor, future_data: torch.Tensor, batch_) -> torch.Tensor:
        ...
        prediction = self.fc2(self.relu(self.fc1(history_data))).transpose(1, 2) # B,L,N
